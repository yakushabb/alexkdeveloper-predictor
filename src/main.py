...
from .window import PredictorWindow

translator_credits = _("translator-credits")

class PredictorApplication(Adw.Application):
    """The main application singleton class."""

    def __init__(self):
        super().__init__(application_id='io.github.alexkdeveloper.predictor',
    ...
    def do_activate(self):
        ...
        if not win:
            win = PredictorWindow(application=self)
        win.present()
